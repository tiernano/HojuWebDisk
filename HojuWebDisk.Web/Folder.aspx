...
<body>
    ...
    <div>
        ...
        <asp:GridView ID="FolderGridView" ShowHeader="false" ShowFooter="false" runat="server"
            CellPadding="4" AutoGenerateColumns="false" ForeColor="#333333" GridLines="None"
            Width="100%" DataKeyNames="ID" OnRowDataBound="FolderGridView_RowDataBound" AllowPaging="false"
            AllowSorting="false" PageSize="25">
        ...
        <br />
        <asp:GridView ID="ResourceGridView" runat="server" ShowHeader="false" CellPadding="4"
            AutoGenerateColumns="false" ForeColor="#333333" GridLines="None" Width="100%"
            DataKeyNames="ID" OnRowDataBound="ResourceGridView_RowDataBound" AllowPaging="false"
            AllowSorting="false" PageSize="25">
